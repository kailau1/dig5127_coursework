        ...
        <div id='productView' style='display:block'>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <td>" . $row["price"] . "</td>
                    <td>
                        <a href='update_product.php?product_id=" . $row["id"] . "' class='btn btn-primary'>Update Product</a>
                    </td>
                    <td>
                        <a href='update_product_media.php?product_id=" . $row["id"] . "' class='btn btn-primary'>Update Media</a>
                    </td>
                    <td>
                        <a href='update_product_attributes.php?product_id=" . $row["id"] . "' class='btn btn-primary'>Update Attributes</a>
                    </td>
                  </tr>";
                }
